...
const DesktopNavbar = () => {
  return (
    <div className="relative z-20 bg-white w-full mx-auto px-6 md:px-10 xxl:px-20 2xl:px-20 h-[80px] hidden md:flex items-center justify-between cursor-pointer border-b-[1px] border-[#0000006] tap-transparent ">
