...
const Desktop = () => {
  return (
    <div className="flex flex-col gap-16">
      <div className="hidden absolute bottom-32 md:flex self-center text-[#FFFFFF] bg-[#000000] w-auto rounded-full">
      ...
      <div className="relative z-20 bg-white h-auto border-t-[1px] border-[#dddddd] py-3 px-10 xl:px-20 2xl:px-20 hidden md:flex flex-row items-center md:justify-center xl:justify-between flex-wrap gap-[6px] text-[#222222] text-sm">
        ...
        <ul className="flex font-[cereal-medium] gap-6 ">
